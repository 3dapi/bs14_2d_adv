...
INT_PTR CALLBACK CMain::WndWrk1(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch( uMsg )
	{
		...
		case WM_COMMAND:
		{
			switch(wparLo)
			{
				case IDC_MAP_CREATE:
				{
					HWND hWndCreate= CreateDialog((HINSTANCE)GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_CREATE), GHWND, CMain::WndCrt);
